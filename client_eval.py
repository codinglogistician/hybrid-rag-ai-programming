...
# Przykładowe dane testowe (lokalne – bez wysyłania do LangSmith API)
examples = [
...
# Lokalna lista Example – bez API LangSmith
dataset = [
    Example(
        id=uuid.uuid4(),
...
if __name__ == "__main__":
    results = evaluate(
        ...
        upload_results=False,  # nic nie wysyłane do LangSmith API
    )
    print(results)
